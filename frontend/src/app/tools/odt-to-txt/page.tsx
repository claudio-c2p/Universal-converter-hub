...
export default function Page() {
  ...
  const { status, errorMsg, convert } = useConverter({
    endpoint: '/api/libreoffice/odt-to-txt',
    outputFilename: (name) => name.replace(/\.[^.]+$/, '.txt'),
  });
  return (
    <ToolLayout title="ODT → TXT" description="Converta seu arquivo ODT para TXT de forma rápida e gratuita." category="Documento"
