...
export default function Page() {
  ...
  const { status, errorMsg, convert } = useConverter({
    endpoint: '/api/extra/fb2-to-epub',
    outputFilename: (name) => name.replace(/\.[^.]+$/, '.epub'),
  });
  return (
    <ToolLayout title="FB2 → EPUB" description="Converta seu arquivo FB2 para EPUB de forma rápida e gratuita." category="eBook"
      ...
      <FileDropzone accept=".fb2" maxSizeMB={40} onFileSelect={setFile} label="Arraste o arquivo aqui" />
