...
export default function Page() {
  ...
  const { status, errorMsg, convert } = useConverter({
    endpoint: '/api/extra/epub-to-azw3',
    outputFilename: (name) => name.replace(/\.[^.]+$/, '.azw3'),
  });
  return (
    <ToolLayout title="EPUB → AZW3" description="Converta seu arquivo EPUB para AZW3 de forma rápida e gratuita." category="eBook"
