...
export default function Page() {
  ...
  const { status, errorMsg, convert } = useConverter({
    endpoint: '/api/office/rtf-to-txt',
    outputFilename: (name) => name.replace(/\.[^.]+$/, '.txt'),
  });
  return (
    <ToolLayout title="RTF → TXT" description="Converta seu arquivo de forma rápida e gratuita." category="Office" icon={<ToolIcon d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />}>
      <FileDropzone accept=".rtf" maxSizeMB={20} onFileSelect={setFile} label="Arraste o arquivo aqui" />
