...
export default function Page() {
  ...
  const { status, errorMsg, convert } = useConverter({
    endpoint: '/api/libreoffice/word-to-rtf',
    outputFilename: (name) => name.replace(/\.[^.]+$/, '.rtf'),
  });
  return (
    <ToolLayout title="WORD → RTF" description="Converta seu arquivo DOCX para RTF de forma rápida e gratuita." category="Office"
