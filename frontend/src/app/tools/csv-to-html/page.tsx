...
export default function Page() {
  ...
  const { status, errorMsg, convert } = useConverter({
    endpoint: '/api/office/csv-to-html',
    outputFilename: (name) => name.replace(/\.[^.]+$/, '.html'),
  });
  return (
    <ToolLayout title="CSV → HTML" description="Converta seu arquivo de forma rápida e gratuita." category="Office" icon={<ToolIcon d="M10 20l4-16M6 16l-4-4 4-4M18 8l4 4-4 4" />}>
