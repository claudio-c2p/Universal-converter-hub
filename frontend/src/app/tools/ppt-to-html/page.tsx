...
export default function Page() {
  ...
  const { status, errorMsg, convert } = useConverter({
    endpoint: '/api/libreoffice/ppt-to-html',
    outputFilename: (name) => name.replace(/\.[^.]+$/, '.html'),
  });
  return (
    <ToolLayout title="PPT → HTML" description="Converta seu arquivo PPTX para HTML de forma rápida e gratuita." category="Office"
