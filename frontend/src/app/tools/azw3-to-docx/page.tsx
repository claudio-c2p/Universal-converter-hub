...
export default function Page() {
  ...
  const { status, errorMsg, convert } = useConverter({
    endpoint: '/api/extra/azw3-to-docx',
    outputFilename: (name) => name.replace(/\.[^.]+$/, '.docx'),
  });
  return (
    <ToolLayout title="AZW3 → DOCX" description="Converta seu arquivo AZW3 para DOCX de forma rápida e gratuita." category="eBook"
      ...
      <FileDropzone accept=".azw3" maxSizeMB={40} onFileSelect={setFile} label="Arraste o arquivo aqui" />
