...
export default function Page() {
  ...
  const { status, errorMsg, convert } = useConverter({
    endpoint: '/api/pdf-convert/pdf-to-metadata',
    outputFilename: (name) => name.replace(/\.[^.]+$/, '.json'),
  });
  return (
    <ToolLayout title="Extrair Metadados do PDF" description="Converta seu arquivo de forma rápida e gratuita." category="PDF" icon={<ToolIcon d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />}>
      <FileDropzone accept=".pdf" maxSizeMB={20} onFileSelect={setFile} label="Arraste o arquivo aqui" />
