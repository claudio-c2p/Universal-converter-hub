...
export default function Page() {
  ...
  const { status, errorMsg, convert } = useConverter({
    endpoint: '/api/libreoffice/word-to-odt',
    outputFilename: (name) => name.replace(/\.[^.]+$/, '.odt'),
  });
  return (
    <ToolLayout title="WORD → ODT" description="Converta seu arquivo DOCX para ODT de forma rápida e gratuita." category="Office"
