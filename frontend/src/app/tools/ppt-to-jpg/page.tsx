...
export default function Page() {
  ...
  const { status, errorMsg, convert } = useConverter({
    endpoint: '/api/libreoffice/ppt-to-jpg',
    outputFilename: (name) => name.replace(/\.[^.]+$/, '.jpg'),
  });
  return (
    <ToolLayout title="PPT → JPG" description="Converta seu arquivo PPTX para JPG de forma rápida e gratuita." category="Office"
