...
export default function Page() {
  ...
  const { status, errorMsg, convert } = useConverter({
    endpoint: '/api/data-convert/toml-to-xml',
    outputFilename: (name) => name.replace(/\.[^.]+$/, '.xml'),
  });
  return (
    <ToolLayout title="TOML → XML" description="Converta seu arquivo de forma rápida e gratuita." category="Dados" icon={<ToolIcon d="M10 20l4-16M6 16l-4-4 4-4M18 8l4 4-4 4" />}>
