...
export default function Page() {
  ...
  const { status, errorMsg, convert } = useConverter({
    endpoint: '/api/binary-tools/eps-to-pdf',
    outputFilename: (name) => name.replace(/\.[^.]+$/, '.pdf'),
  });
  return (
    <ToolLayout title="EPS → PDF" description="Converta seu arquivo EPS para PDF de forma rápida e gratuita." category="Documento"
