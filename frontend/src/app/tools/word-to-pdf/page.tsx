...
export default function Page() {
  ...
  const { status, errorMsg, convert } = useConverter({
    endpoint: '/api/libreoffice/word-to-pdf',
    outputFilename: (name) => name.replace(/\.[^.]+$/, '.pdf'),
  });
  return (
    <ToolLayout title="WORD → PDF" description="Converta seu arquivo DOCX para PDF de forma rápida e gratuita." category="Office"
