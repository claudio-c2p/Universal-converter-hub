...
export default function Page() {
  ...
  const { status, errorMsg, convert } = useConverter({
    endpoint: '/api/office/json-to-excel',
    outputFilename: (name) => name.replace(/\.[^.]+$/, '.xlsx'),
  });
  return (
    <ToolLayout title="JSON → Excel" description="Converta seu arquivo de forma rápida e gratuita." category="Dados" icon={<ToolIcon d="M3 10h18M3 14h18m-9-4v8m-7 0h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />}>
