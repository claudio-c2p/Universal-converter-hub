...
export default function Page() {
  ...
  const { status, errorMsg, convert } = useConverter({
    endpoint: '/api/office/docx-to-md',
    outputFilename: (name) => name.replace(/\.[^.]+$/, '.md'),
  });
  return (
    <ToolLayout title="Word → Markdown" description="Converta seu arquivo de forma rápida e gratuita." category="Office" icon={<ToolIcon d="M7 8h10M7 12h6m-6 4h4M19 21H5a2 2 0 01-2-2V5a2 2 0 012-2h11l5 5v11a2 2 0 01-2 2z" />}>
      <FileDropzone accept=".docx,.doc" maxSizeMB={20} onFileSelect={setFile} label="Arraste o arquivo aqui" />
