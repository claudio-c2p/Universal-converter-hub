...
export default function Page() {
  ...
  const { status, errorMsg, convert } = useConverter({
    endpoint: '/api/libreoffice/ppt-to-png',
    outputFilename: (name) => name.replace(/\.[^.]+$/, '.png'),
  });
  return (
    <ToolLayout title="PPT → PNG" description="Converta seu arquivo PPTX para PNG de forma rápida e gratuita." category="Office"
      ...
      <FileDropzone accept=".pptx,.ppt" maxSizeMB={25} onFileSelect={setFile} label="Arraste o arquivo aqui" />
