...
export default function Page() {
  ...
  const { status, errorMsg, convert } = useConverter({
    endpoint: '/api/binary-tools/ocr-to-searchable-pdf',
    outputFilename: (name) => name.replace(/\.[^.]+$/, '.pdf'),
  });
  return (
    <ToolLayout title="OCR → SEARCHABLE-PDF" description="Converta seu arquivo JPG para PDF de forma rápida e gratuita." category="PDF"
